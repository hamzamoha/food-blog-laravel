<template>
    <div class="bg-white p-6 animate-push">
        <!-- Articles -->
        <h2 class="mb-4 text-2xl font-semibold">All Articles <router-link to="/articles/create"
            ...
            <tbody>
                <tr class="border-b" v-for="(article, index) in articles" :key="index">
                    ...
                    <td class="px-3 py-1 whitespace-nowrap">
                        <button class="bg-neutral-200 rounded py-1 px-2 hover:bg-neutral-300 text-neutral-700 mr-1"><i
